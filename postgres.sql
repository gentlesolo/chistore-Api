...
--
-- Name: books; Type: TABLE; Schema: public; Owner: nmadhab
--
...
ALTER TABLE public.books OWNER TO nmadhab;
...
ALTER SEQUENCE public.products_id_seq OWNED BY public.books.id;
...
--
-- Name: books id; Type: DEFAULT; Schema: public; Owner: nmadhab
--

ALTER TABLE ONLY public.books ALTER COLUMN id SET DEFAULT nextval('public.products_id_seq'::regclass);
...
--
-- Data for Name: books; Type: TABLE DATA; Schema: public; Owner: nmadhab
--

COPY public.books (id, description, imageurl, name, price, category_id) FROM stdin;
\.
...
--
-- Name: books products_pkey; Type: CONSTRAINT; Schema: public; Owner: nmadhab
--
...
ALTER TABLE ONLY public.wishlist
    ADD CONSTRAINT fk6p7qhvy1bfkri13u29x6pu8au FOREIGN KEY (product_id) REFERENCES public.books(id);


--
-- Name: books fkog2rp4qthbtt2lfyhfo32lsw9; Type: FK CONSTRAINT; Schema: public; Owner: nmadhab
--
...
ALTER TABLE ONLY public.cart
    ADD CONSTRAINT fkpu4bcbluhsxagirmbdn7dilm5 FOREIGN KEY (product_id) REFERENCES public.books(id);
...
ALTER TABLE ONLY public.orderitems
    ADD CONSTRAINT fkqu7dfdpbhltsgxfq2ahkdnyv5 FOREIGN KEY (product_id) REFERENCES public.books(id);
